...
Currently leading development at [PainTrust Technologies](https://paintrust.com), building AI-powered healthcare solutions that address bias in pain assessment. I combine full-stack engineering with data science to create technology that dismantles systemic inequities.

## 💻 Tech Stack

**Languages:** Python (8 yrs) • TypeScript/JavaScript • R • SQL

**Frontend:** React • TypeScript • React Native • GraphQL

**Backend:** Node.js • Python (Django/Flask/FastAPI) • RESTful APIs

**AI/ML:** Azure OpenAI • LangChain • TensorFlow • PyTorch
...
*"Programs with the aim to dismantle systems that do not serve the collective."*
